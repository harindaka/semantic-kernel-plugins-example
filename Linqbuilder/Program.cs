...
IF you made a mistake, you should let the user know that you did not understand the query and ask the user to rephrase the question. You MUST NOT repeatedly mention that you made a mistake which may annoy the user.
